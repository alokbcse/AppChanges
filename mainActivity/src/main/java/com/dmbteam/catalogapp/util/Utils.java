...
public class Utils {
	...
	static {
		if (AppSettings.useCommaForPrices) {
			DecimalFormatSymbols commaSeparator = new DecimalFormatSymbols();
			commaSeparator.setDecimalSeparator(',');
			mFormatter = new DecimalFormat("#0.00", commaSeparator);
		}
	}
